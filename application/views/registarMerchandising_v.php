        ...
        <div class="row">
            ...
            <div class="col-md-12">
                ...
                <div class="box box-primary">
                    ...
                    <?php echo form_open_multipart('Merchandising/registarMerchandising'); ?>
...
<!--                        passar atributo ativo -->
                        ...
                        <div class="col-md-6 form-group">    
                            ...
                            <input type="text" class="form-control" value="<?php echo set_value('tipo'); ?>" name="tipo" placeholder="Introduza o Tipo Merchandising...">                     
                        </div>

                        <div class="col-md-6 form-group">
                            <label>Quantidade</label>
                            <input type="text" class="form-control" value="<?php echo set_value('quantidade'); ?>" name="quantidade" placeholder="Introduza a Quantidade...">
                        </div>
